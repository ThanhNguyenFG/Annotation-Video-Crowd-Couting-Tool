...
window.wheelzoom = (function(){
	...
	var main = function(img, options){
		...
		var bgPosX_ = Number(document.getElementById("bgPosX").value);
		var bgPosY_ = Number(document.getElementById("bgPosY").value);
		var bgWidth_ = Number(document.getElementById("bgWidth").value);
		var bgHeight_ = Number(document.getElementById("bgHeight").value);
